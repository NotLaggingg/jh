...
local AimwareSettings = getgenv().AimwareSettings
...
Target = {
    ...
    TargetUser = nil,
    WallCheck = false,
    Bind = AimwareSettings.TargetKey
}
}
...
local NotifyLibrary = Module.Functions.HttpGet("https://raw.githubusercontent.com/laagginq/aimwarev2/main/notify.lua")
local Notify = NotifyLibrary.Notify
Module.Functions.Init()
Library.theme.topheight = 50
Library.theme.accentcolor = Color3.fromRGB(137,42,236)
Library.theme.accentcolor2 = Color3.fromRGB(110, 0, 225)
Library.theme.fontsize = 15
Library.theme.titlesize = 17

if AimwareSettings.Watermark == true then

Library:CreateWatermark("Aimware - "..ver..", FPS: {fps} ")
...
if not AimwareSettings.PerformanceMode then
local ESPLibrary = Module.Functions.HttpGet("https://raw.githubusercontent.com/laagginq/aimwarev2/main/esp.lua")
